 ...
 *
 * An empty string renders on the page as a visible untranslated marker, never
 * as silent English, so no value here is ever left empty.
 */
export const fr: SiteContent = {
  ...
  premise: {
    ...
    lines: [
      "Ce jour-là, rien ne s’est mal passé.",
      "Les instruments fonctionnaient.",
      "Les données étaient là depuis le début."
    ],
    mechanism: [
