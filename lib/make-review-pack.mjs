...
const WHERE = {
  ...
  reading: "“Before we begin” — the three instructions",
  loops: "The state line — Time, Attention, Safety",
  cases: "Case evidence cards",
  excerpt: "The extract — opening pages of the book",
  listen: "Audio player",
  about: "About the book, evidence markers, chapter map",
