...
const FILES = [
  ...
  // All rendered from the final KDP cover PDF on 14 September 2026; the
  // print-ready PDF is that file itself.
  ...
  // book-render.png withdrawn 20 Sep 2026: the 3D render still prints the retired subtitle. Re-add after a new render.
  // The author.
  ["author-photo-1600.jpg", "author-photo-1600px.jpg"],
  // The extract, set from content/en.ts, checked against v44 on 14 September 2026.
