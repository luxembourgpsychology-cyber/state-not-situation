 ...
 * printed pages. When the book is re-exported, replace it with pages 1 to 3
...
const infoId = add(`<< /Title (State. Not Situation. \\227 the opening) /Author (Ivana Budi\\232in) /Subject (Extract, pages 1 to 3) /Producer (Budisin Publishing) >>`);
