...
- **Instrument text.** IBM Plex Mono, small, tracked. On the site: times, labels, page numbers, the state-line legend, the colophon.
...
- The **vertical loop bar** beside chapter openers: the three loops.
- The **CASE EVIDENCE page**: reproduced as the cards, label for label.
